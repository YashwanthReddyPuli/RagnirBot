  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '400px',
        height: '400px',
        background: 'radial-gradient(circle, rgba(239, 68, 68, 0.15) 0%, rgba(220, 38, 38, 0.05) 50%, rgba(0,0,0,0) 100%)',
        borderRadius: '50%',
        filter: 'blur(40px)',
        zIndex: 0
      }} />
      ...
      <div className="glass-panel animate-fade-in" style={{
        ...
        >
          {loading ? 'Connecting...' : (
            <>
              <svg width="20" height="20" viewBox="0 0 127.14 96.36" fill="currentColor" style={{ marginRight: '8px' }}>
