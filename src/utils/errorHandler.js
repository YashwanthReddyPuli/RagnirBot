 ...
 * 
 * This module provides structured error handling for the RagnirBot application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw RagnirBotError for application-specific errors
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new RagnirBotError(message, type, userMessage, normalizedContext);
}
